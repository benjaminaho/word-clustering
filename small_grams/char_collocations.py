...
probability of gram 1 occuring given that gram 2 occurs next in a word is the same as the
...
Using a not-carefully constructed corpus of English (several arbitrary texts from Project Gutenburg),
...
English. Other detected word-parts are more lexical than functional, such as " comm", "abilit", and
...
# Find number of individual grams (tokens, not types) of a given length in the set of all word types in the corpus.
